...
> **Status rollup:** **13 / 24 done** · **1 doing** (#9 — channel lifecycle Phases 1–4 + recovery refinements + per-Sink ArtifactChannel (#9(b), via #14) landed & **live-verified**; remaining: P5 gateway handshake timers→#20, P6 `restart_epoch`→#10, real manifest idempotency key) · 0 blocked · **1 spec✓** (#3 — code half pending) · 9 todo (incl. #11 **queued next**) — _updated 2026-06-17_. Bump this line whenever a row's **Status** changes.
