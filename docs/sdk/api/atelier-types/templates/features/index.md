# `atelier_types::templates::features`

Feature definition templates.

!!! info "Skeleton API reference"
    This page lists the public items in `atelier_types::templates::features`. For full
    signatures, source links, and trait implementations, see the
    [docs.rs page for this module](https://docs.rs/atelier-types/0.0.10/atelier_types/templates/features/).
...
| Item | Summary |
| --- | --- |
| [`Features`](https://docs.rs/atelier-types/0.0.10/atelier_types/templates/features/enum.Features.html) | Available feature types for configuration templates. |
