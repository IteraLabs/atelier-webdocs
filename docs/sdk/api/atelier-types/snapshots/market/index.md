...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-types/latest/atelier_types/snapshots/market/).

## Structs

| Item | Summary |
| --- | --- |
| [`MarketSnapshot`](https://docs.rs/atelier-types/latest/atelier_types/snapshots/market/struct.MarketSnapshot.html) | A point-in-time view of the market across all data sources. |
