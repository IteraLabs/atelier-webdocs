...
| [`DataWorkerConfig`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/config/workers/data_worker_config/struct.DataWorkerConfig.html) | Fully-resolved configuration for a single `DataWorker`. |
...
| [`DataWorkerManifest`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/config/workers/data_worker_config/struct.DataWorkerManifest.html) | Top-level TOML manifest for spawning multiple `DataWorker`s. |
