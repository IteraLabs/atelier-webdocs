...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/0.0.10/atelier_connect/config/workers/common/).
...
| Item | Summary |
| --- | --- |
| [`OutputSinkConfig`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/config/workers/common/enum.OutputSinkConfig.html) | Describes a single output sink, deserializable from TOML. |
