...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/latest/atelier_connect/sources/kraken/decoder/).

## Structs

| Item | Summary |
| --- | --- |
| [`KrakenDecoder`](https://docs.rs/atelier-connect/latest/atelier_connect/sources/kraken/decoder/struct.KrakenDecoder.html) | `WssDecoder` implementation for the Kraken WebSocket v2 API. |
