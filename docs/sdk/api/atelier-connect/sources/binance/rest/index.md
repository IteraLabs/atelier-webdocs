...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/latest/atelier_connect/sources/binance/rest/).

## Structs

| Item | Summary |
| --- | --- |
| [`BinanceRestClient`](https://docs.rs/atelier-connect/latest/atelier_connect/sources/binance/rest/struct.BinanceRestClient.html) | Binance REST API client for public market data. |
