...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/latest/atelier_connect/sources/coinbase/tooling/).

## Functions

| Item | Summary |
| --- | --- |
| [`channels_for_config`](https://docs.rs/atelier-connect/latest/atelier_connect/sources/coinbase/tooling/fn.channels_for_config.html) | Build the list of Coinbase channels to subscribe to based on enabled data types. |
