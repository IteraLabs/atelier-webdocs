...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/latest/atelier_connect/sources/coinbase/events/).

## Enums

| Item | Summary |
| --- | --- |
| [`CoinbaseWssEvent`](https://docs.rs/atelier-connect/latest/atelier_connect/sources/coinbase/events/enum.CoinbaseWssEvent.html) | Events produced by `CoinbaseDecoder` from the Advanced Trade WSS feed. |
