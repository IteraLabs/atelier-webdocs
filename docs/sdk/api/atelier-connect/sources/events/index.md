...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/latest/atelier_connect/sources/events/).

## Enums

| Item | Summary |
| --- | --- |
| [`ExchangeEvent`](https://docs.rs/atelier-connect/latest/atelier_connect/sources/events/enum.ExchangeEvent.html) | Exchange-agnostic event wrapper. |
