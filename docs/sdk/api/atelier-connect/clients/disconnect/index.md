...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/0.0.10/atelier_connect/clients/disconnect/).

## Enums

| Item | Summary |
| --- | --- |
| [`DisconnectReason`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/clients/disconnect/enum.DisconnectReason.html) | Why a WebSocket connection terminated. |
| [`WssExitReason`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/clients/disconnect/enum.WssExitReason.html) | Why a WebSocket client's message loop exited. |
