...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/0.0.10/atelier_connect/clients/reconnect/).
...
| Item | Summary |
| --- | --- |
| [`ConnectionHealth`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/clients/reconnect/trait.ConnectionHealth.html) | Per-exchange staleness timeout configuration. |
