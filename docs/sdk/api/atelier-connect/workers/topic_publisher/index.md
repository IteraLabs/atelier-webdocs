...
!!! info "Skeleton API reference"
    ...
    [docs.rs page for this module](https://docs.rs/atelier-connect/0.0.10/atelier_connect/workers/topic_publisher/).
...
| Item | Summary |
| --- | --- |
| [`DEFAULT_CHANNEL_CAPACITY`](https://docs.rs/atelier-connect/0.0.10/atelier_connect/workers/topic_publisher/constant.DEFAULT_CHANNEL_CAPACITY.html) | Default broadcast channel capacity per topic. |
